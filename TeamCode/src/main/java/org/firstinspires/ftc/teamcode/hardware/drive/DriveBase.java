...
public class DriveBase extends ConfiguredMecanumDrive {
    ...
    public static float PASSED_TRANSLATIONAL_VELOCITY_MULTIPLIER = HIGH_TRANSLATIONAL_VELOCITY_MULTIPLIER;
    ...
    public void moveUsingRR(double x, double y, double turn){
        if(lowPowerMode){
            PASSED_TRANSLATIONAL_VELOCITY_MULTIPLIER = LOW_TRANSLATIONAL_VELOCITY_MULTIPLIER;
        } else {
            PASSED_TRANSLATIONAL_VELOCITY_MULTIPLIER = HIGH_TRANSLATIONAL_VELOCITY_MULTIPLIER;
        }
