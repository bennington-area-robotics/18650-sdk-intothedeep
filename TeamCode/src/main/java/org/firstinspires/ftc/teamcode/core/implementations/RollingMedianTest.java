...
@Config
@TeleOp(name="PotentiometerMedianTest")
public class RollingMedianTest extends BasicOpModeCore {
	...
	protected void initialize(){
		super.initialize();
		potentiometer = Hardware.getPotentiometer("encoder", 360, 3.3, new RollingMedian(200));
