 ...
 */
@Config
public class ConfiguredMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(3.5, 0.001, 0.05);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(2.5, 0.001, 0.04);

    public static double LATERAL_MULTIPLIER = 1.428571429;
    ...
    public List<Double> getWheelVelocities() {
        lastEncVelocities.clear();

        List<Double> wheelVelocities = new ArrayList<>();
        for (DcMotorEx motor : motors) {
            int vel = (int) motor.getVelocity();
            lastEncVelocities.add(vel);
