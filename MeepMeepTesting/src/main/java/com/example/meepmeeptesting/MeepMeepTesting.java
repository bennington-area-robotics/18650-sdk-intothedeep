    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(24, 63, Math.toRadians(-90)))
                        .splineToSplineHeading(new Pose2d(40, 45, Math.toRadians(180)), Math.toRadians(0))
                        .splineToSplineHeading(new Pose2d(52, 49, Math.toRadians(215)), Math.toRadians(45))
                        //.splineTo(new Vector2d(55,45), Math.toRadians(90))
                        .splineToSplineHeading(new Pose2d(55, 45, Math.toRadians(-90)), Math.toRadians(-90))
                        .splineToConstantHeading(new Vector2d(55, 40), Math.toRadians(-90))
                        /*.back(25)
                        .forward(3)
